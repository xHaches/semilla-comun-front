...
import { useProyectosQuery } from "../../../../gql/schema";
import { UTCToInputDate } from "../../../../shared/helpers/UTCToInputDate";

const Projects = () => {
  const { data, refetch } = useProyectosQuery();
  ...
  return (
    <>
      <PageHeader text="Proyectos" />
      <Screen>
        <ul role="list" className="divide-y divide-gray-100">
          {data?.proyectos
            .filter((p) => p.usuario_administrador_id !== user.usuario_id)
            .map((project) => (
              <li
